...
alibi_pformat = partial(PrettyPrinter().pformat)
...
class Base:
    ...
    meta: dict = attr.ib(
        default=attr.Factory(default_meta), repr=alibi_pformat
    )  #: Object metadata.
...
class Explanation:
    ...
    def __getitem__(self, item):
        ...
        msg = (
            "The Explanation object is not a dictionary anymore and accessing elements should "
